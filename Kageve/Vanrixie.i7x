...
[Won Husky Combat]
	...
	if fightoutcome < 20: [player won]
		...
		if Player consents:[Accept]
			...
			say"'Ah, that is too bad, perhaps when you're feeling better.' the tigress remarks with a hint of pity. 'Help yourself to some snacks and drinks in that corner, you're free to stay as long as you want.' she adds, guesturing to the pile of food and drink. Feeling that you've stayed too long in the tiger's den, you get up on your feet, grab your gear and prepare to set off. The tigress, seeing you set out to leave, rises from the love nest, sexual fluids dripping from her crotch, leaving an alabaster trail along the floor as she approaches you. You tense for a moment, prepared to run, thinking the tigress is going to jump you, but she simply gives you a hug, enveloping her in her bosom and nuzzling you on the head with her fluffy cheeks."
	else if fightoutcome is 30: [fled]
		LineBreak;
		say "			One of the huskies fighting the tigress stumbles into the one you're currently fighting, and you use the distraction to run out the back door as the pack is occupied by the tigeress' might.";
		now Resolution of Cornered Tigress is 4; [Player help tigress, player fled]

	...
	say "     Curiosity gets the better of you and you decide to try and involve yourself in whatever's going on. Do you charge right in? Or perhaps take a more passive approach and sneak in?";
		...
		if Player consents: [CHARGE IN]
			...
			if Player consents: [Help the Tiger Woman]
				...
				say "     Deciding to favor the tiger woman, you take advantage of your suprise entrance, you charge towards the nearest husky, slamming into them and sending them sprawling into a shelf, unconcious. Another member of the pack quickly stands over their fallen comrade and comes at you.";
				say "[GroupFight1]";

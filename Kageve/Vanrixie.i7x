	...
	say "     Curiosity gets the better of you and you decide to try and involve yourself in whatever's going on. Do you charge right in? Or perhaps take a more passive approach and sneak in?";
		...
		if Player consents: [CHARGE IN]
			...
			if Player consents: [Help the Tiger Woman]
				...
				say "     Deciding to favor the huskies, you take advantage of your suprise entrance, you charge towards the tiger woman as the other huskies hound her, slamming into the tigeress' back and sending her sprawling. Now that she's prone, the pack pounces upon her, some grabbing the assorted fabric strewn about to tie the downed tigress up. It's not long before she's completely tied up. Her mouth is gagged with a bunch of t-shirts balled up and shoved into her mouth, secured and tied around the back of her head with the sleeves of a few sweaters. Her left arm is tied to her left leg, and her right arm tied to her right leg respectively, having been shoved into the pant legs of multiple jeans and strapped up with belts. The result looks like badly botched attempt at some hybrid of dress up and yoga, but it is effective at restraining the livid tigress. Unsurprisingly her three rows of breasts, fleshy dark-pink feline quim and pucker are left easily accessible.";
...
to say HuskyTigerGroupOrgy:
	...
	if MaleList is not banned: [Male Husky anal]
		say "Hus";
	else: [Bitch husky eat ass]
		say "Hus";

	say"It is not long till a series of orgasms wrack your body and you satisfy the first group of huskies. Their sexual appetite apppeased for now, you are given a moment's respite from the orgy and a view of what is happening to the tigress."
